...
JOINT_DATA = ['knee_pos_motor' , 'knee_pos_encorder']
        ...
        try:
            ...
            try:
                ...
                #self.buff_y.append(msg.data[0])
                    self.curve['knee_pos_motor']['buff_y'].append(msg.data[3])
                    self.curve['knee_pos_motor']['buff_x'].append(rospy.get_time() - self.start_time)
