...
class PlotWidget(QWidget):
    ...
    def __init__(self):
        ...
        #ui
        rp = rospkg.RosPack()
        ui_file = os.path.join('/home/zhangzhi/catkin_ws/src/dragon_robot/dragon_visualization/rqt_plot_entire/src/rqt_plot_entire/rqt_plot_lf_foot' , 'resource' , 'plot.ui')
        loadUi(ui_file , self)
