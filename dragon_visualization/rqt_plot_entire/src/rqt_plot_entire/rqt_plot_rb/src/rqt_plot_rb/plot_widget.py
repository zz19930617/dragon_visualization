...
class PlotWidget(QWidget):
    ...
    def __init__(self):
        ...
        #ui
        rp = rospkg.RosPack()
        ui_file = os.path.join('/home/zhangzhi/catkin_ws/src/dragon_robot/dragon_visualization/rqt_plot_entire/src/rqt_plot_entire/rqt_plot_rb' , 'resource' , 'plot.ui')
        loadUi(ui_file , self)
        ...
        try:
            ...
            try:
                ...
                #self.buff_y.append(msg.data[0])
                    self.curve['hip_motor']['buff_y'].append(msg.data[6])
                    self.curve['knee_motor']['buff_y'].append(msg.data[7])
        ...
        try:
            ...
            try:
                if msg.position is not []:
                    self.curve['hip_encorder']['buff_y'].append(msg.position[4])
                    self.curve['knee_encorder']['buff_y'].append(msg.position[5])
                #if msg.__class__._has_header:
